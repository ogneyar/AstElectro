    ...
    return (
        <InfoPage>
            <div className="TermsOfUse">
                ...
                <header>Пользовательское соглашение сайта astelectro.ru</header>

                <p>Настоящий документ "Пользовательское соглашение" представляет собой предложение ООО "АСТ" (далее — «Администрация»), заключить договор на изложенных ниже условиях Соглашения.</p>
                ...
                <p>в) Сайт Администрации/ Сайт — интернет-сайты, размещенные в домене https://astelectro.ru и его поддоменах.</p>
                ...
                <p>5.4. Действующая редакция настоящего Соглашения размещена на Сайте Правообладателя и доступна в сети Интернет по адресу <NavLink to={TERMS_OF_USE_ROUTE}>astelectro.ru/terms_of_use</NavLink></p>

                <p>Редакция от 15 марта 2023г.</p>
            </div>
        </InfoPage>
    )
}
